      ...
      <Layout>
        ...
        >
          ...
          <Menu
            mode="inline"
            selectedKeys={[
              location.pathname.includes('coze-practice-admin') ? 'admin' :
              location.pathname.includes('admin') ? 'admin' :
              (location.pathname.includes('dynamic-exam') || location.pathname.includes('coze-practice')) ? 'dynamic-exam' : 'trainee'
            ]}
