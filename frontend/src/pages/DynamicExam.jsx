...
const DynamicExam = () => {
  ...
  const renderResultModal = () => {
    ...
    weaknessTags.forEach(t => {
      if (t.dimension === 'business') suggestions.push(`进行反向训练：针对「${t.tag}」的错题变种`)
    })
        ...
        <div style={{ maxHeight: '70vh', overflowY: 'auto', paddingRight: 8 }}>
          ...
          <Row gutter={16} align="middle" style={{ marginBottom: 16 }}>
            ...
            <Col span={16}>
              <Row gutter={[8, 8]}>
                <Col span={8}>
                  <Card size="small" style={{ textAlign: 'center', borderTop: `3px solid ${dimensionColor(score.business_score)}` }}>
                    <Statistic
                      title={details.exam_mode === 'project' ? "业务分 (40%)" : "业务分 (60%)"}
                      value={score.business_score}
                      valueStyle={{ color: dimensionColor(score.business_score), fontWeight: 700 }}
                    />
                  </Card>
                </Col>
                <Col span={8}>
                  <Card size="small" style={{ textAlign: 'center', borderTop: `3px solid ${dimensionColor(score.emotion_score)}` }}>
                    <Statistic
                      title={details.exam_mode === 'project' ? "情绪管理分 (20%)" : "情绪管理分 (25%)"}
                      value={score.emotion_score}
                      valueStyle={{ color: dimensionColor(score.emotion_score), fontWeight: 700 }}
                    />
                  </Card>
                </Col>
                <Col span={8}>
                  <Card size="small" style={{ textAlign: 'center', borderTop: `3px solid ${dimensionColor(score.efficiency_score)}` }}>
                    <Statistic
                      ...
                      valueStyle={{ color: dimensionColor(score.efficiency_score), fontWeight: 700 }}
                    />
                  </Card>
                </Col>
              </Row>
              {/* V3.4: 项目制模式下显示项目维度评分 */}
              {details.exam_mode === 'project' && (
              ...
              <Card size="small" style={{ marginTop: 8, background: '#fffbe6', border: '1px dashed #faad14' }}>
                <Space>
                  <ThunderboltOutlined style={{ color: '#faad14' }} />
                  <Text>突发状况附加分：</Text>
                  <Text strong style={{ color: score.bonus_score > 0 ? '#52c41a' : '#8c8c8c' }}>
                    +{score.bonus_score} 分
                  </Text>
                  <Text type="secondary" style={{ fontSize: 12 }}>
          ...
          <Row gutter={16} style={{ marginBottom: 16 }}>
            ...
            <Col span={18}>
              <Descriptions column={2} size="small" bordered>
                ...
                <Descriptions.Item label="业务分">{d.business_score}</Descriptions.Item>
                <Descriptions.Item label="情绪管理分">{d.emotion_score}</Descriptions.Item>
                <Descriptions.Item label="效率分">{d.efficiency_score}</Descriptions.Item>
                <Descriptions.Item label="附加分">+{d.bonus_score}</Descriptions.Item>
